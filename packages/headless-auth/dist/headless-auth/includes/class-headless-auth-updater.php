...
/**
 * Auto-updater for Headless Auth.
 *
 * Queries GitHub Releases for tags prefixed "headless-auth@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Auth_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-auth@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-auth';
	const PLUGIN_SLUG = 'headless-auth';
	const ZIP_NAME    = 'headless-auth.zip';
	const CACHE_KEY   = 'headless_auth_gh_release_cache';
