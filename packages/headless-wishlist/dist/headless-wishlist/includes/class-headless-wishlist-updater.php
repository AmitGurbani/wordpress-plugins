...
/**
 * Auto-updater for Headless Wishlist.
 *
 * Queries GitHub Releases for tags prefixed "headless-wishlist@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Wishlist_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-wishlist@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-wishlist';
	const PLUGIN_SLUG = 'headless-wishlist';
	const ZIP_NAME    = 'headless-wishlist.zip';
	const CACHE_KEY   = 'headless_wishlist_gh_release_cache';
