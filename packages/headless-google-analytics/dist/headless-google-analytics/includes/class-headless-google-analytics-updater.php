...
/**
 * Auto-updater for Headless Google Analytics.
 *
 * Queries GitHub Releases for tags prefixed "headless-google-analytics@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Google_Analytics_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-google-analytics@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-google-analytics';
	const PLUGIN_SLUG = 'headless-google-analytics';
	const ZIP_NAME    = 'headless-google-analytics.zip';
	const CACHE_KEY   = 'headless_google_analytics_gh_release_cache';
