  ...
  return (
    <DiagnosticsPanel
      ...
      testAction={{
        ...
        description: __('Send a test page_view event to the GA4 Measurement Protocol debug endpoint. This validates your payload structure but does not verify your Measurement ID or API Secret — check GA4 Realtime to confirm events arrive.', 'headless-google-analytics'),
