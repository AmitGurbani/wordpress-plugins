    ...
    <div style={{ padding: '16px 0', maxWidth: '600px' }}>
      <ToggleControl
        ...
        help={settings.fuzzy_enabled
          ? __('Fuzzy matching is ON. Misspellings will be corrected automatically.', 'headless-fuzzyfind')
          : __('Enable to handle misspellings and typos using edit-distance matching.', 'headless-fuzzyfind')
        }
      ...
      <ToggleControl
        ...
        help={settings.autocomplete_enabled
          ? __('Autocomplete endpoint is active at /headless-fuzzyfind/v1/autocomplete.', 'headless-fuzzyfind')
          : __('Enable the REST API autocomplete endpoint for search-as-you-type.', 'headless-fuzzyfind')
        }
      ...
      <NumberControl
        ...
        help={__('Minimum characters required to trigger enhanced search. Default: 2.', 'headless-fuzzyfind')}
      ...
      <NumberControl
        ...
        help={__('Show suggestions when results are fewer than this number. Default: 3.', 'headless-fuzzyfind')}
