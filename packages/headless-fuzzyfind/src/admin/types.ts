...
export const TABS = [
  { name: 'weights', title: __('Weights', 'headless-fuzzyfind') },
  { name: 'features', title: __('Features', 'headless-fuzzyfind') },
  { name: 'index', title: __('Index', 'headless-fuzzyfind') },
  { name: 'analytics', title: __('Analytics', 'headless-fuzzyfind') },
];
