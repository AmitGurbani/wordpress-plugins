...
class Headless_Fuzzyfind_Activator {
	...
	public static function activate() {
		...
		dbDelta( $sql_index );
		dbDelta( $sql_log );
		update_option( 'headless_fuzzyfind_index_table', $index_table );
		update_option( 'headless_fuzzyfind_log_table', $log_table );
		update_option( 'headless_fuzzyfind_db_version', '1.0.0' );
	}
}
