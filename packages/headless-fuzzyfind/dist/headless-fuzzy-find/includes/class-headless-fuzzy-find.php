...
class Headless_Fuzzyfind {
	...
	private function load_dependencies() {
		...
		$this->loader = new Headless_Fuzzyfind_Loader();
	}
	...
	private function define_public_hooks() {
		$public = new Headless_Fuzzyfind_Public( $this->plugin_name, $this->version );
		...
		$this->loader->add_action( 'headless_fuzzyfind_do_reindex', $public, 'do_reindex', 10, 0 );
	}
