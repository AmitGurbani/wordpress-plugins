 ...
 * Text Domain:       headless-fuzzy-find
...
define( 'HEADLESS_FUZZY_FIND_VERSION', '1.3.0' );
...
function activate_headless_fuzzy_find() {
	...
	Headless_Fuzzy_Find_Activator::activate();
}
...
function deactivate_headless_fuzzy_find() {
	...
	Headless_Fuzzy_Find_Deactivator::deactivate();
}
