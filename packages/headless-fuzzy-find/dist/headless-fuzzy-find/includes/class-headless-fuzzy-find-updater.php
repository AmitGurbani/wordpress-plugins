...
/**
 * Auto-updater for Headless Fuzzy Find.
 *
 * Queries GitHub Releases for tags prefixed "headless-fuzzy-find@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Fuzzy_Find_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-fuzzy-find@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-fuzzy-find';
	const PLUGIN_SLUG = 'headless-fuzzy-find';
	const ZIP_NAME    = 'headless-fuzzy-find.zip';
	const CACHE_KEY   = 'headless_fuzzy_find_gh_release_cache';
