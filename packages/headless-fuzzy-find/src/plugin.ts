/**
 * Headless Fuzzy Find — wpts Plugin
 *
...
@AdminPage({
  pageTitle: 'Headless Fuzzy Find Settings',
  menuTitle: 'Fuzzy Find',
...
class FuzzyFind {
  ...
  onActivation(): void {
    ...
    updateOption('headless_fuzzy_find_index_table', indexTable);
    updateOption('headless_fuzzy_find_log_table', logTable);
    updateOption('headless_fuzzy_find_db_version', '1.0.0');
  }
