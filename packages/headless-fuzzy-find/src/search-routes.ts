/**
 * Fuzzy Find Search Routes — Custom REST endpoints for search and autocomplete.
 *
 * GET /headless-fuzzy-find/v1/search?query=...&page=1&per_page=10&orderby=relevance
 * GET /headless-fuzzy-find/v1/autocomplete?query=...&limit=8
 *
