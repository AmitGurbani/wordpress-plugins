...
/**
 * Auto-updater for Headless Orders.
 *
 * Queries GitHub Releases for tags prefixed "headless-orders@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Orders_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-orders@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-orders';
	const PLUGIN_SLUG = 'headless-orders';
	const ZIP_NAME    = 'headless-orders.zip';
	const CACHE_KEY   = 'headless_orders_gh_release_cache';
