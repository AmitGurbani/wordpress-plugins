...
/**
 * Auto-updater for Headless Clarity.
 *
 * Queries GitHub Releases for tags prefixed "headless-clarity@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Clarity_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-clarity@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-clarity';
	const PLUGIN_SLUG = 'headless-clarity';
	const ZIP_NAME    = 'headless-clarity.zip';
	const CACHE_KEY   = 'headless_clarity_gh_release_cache';
