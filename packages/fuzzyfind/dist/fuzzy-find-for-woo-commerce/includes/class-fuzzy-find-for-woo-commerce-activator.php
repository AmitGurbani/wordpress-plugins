...
class Fuzzyfind_For_Woocommerce_Activator {
	...
	public static function activate() {
		...
		dbDelta( $sql_index );
		dbDelta( $sql_log );
		update_option( 'fuzzyfind_index_table', $index_table );
		update_option( 'fuzzyfind_log_table', $log_table );
		update_option( 'fuzzyfind_db_version', '1.0.0' );
	}
}
