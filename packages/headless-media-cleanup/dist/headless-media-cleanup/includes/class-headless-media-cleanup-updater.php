...
/**
 * Auto-updater for Headless Media Cleanup.
 *
 * Queries GitHub Releases for tags prefixed "headless-media-cleanup@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Media_Cleanup_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-media-cleanup@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-media-cleanup';
	const PLUGIN_SLUG = 'headless-media-cleanup';
	const ZIP_NAME    = 'headless-media-cleanup.zip';
	const CACHE_KEY   = 'headless_media_cleanup_gh_release_cache';
