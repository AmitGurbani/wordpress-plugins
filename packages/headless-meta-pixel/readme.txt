...
1. Upload the plugin files to the `/wp-content/plugins/headless-meta-pixel` directory, or install the plugin through the WordPress plugins screen directly.
