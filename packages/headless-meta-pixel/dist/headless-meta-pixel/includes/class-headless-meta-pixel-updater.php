...
/**
 * Auto-updater for Headless Meta Pixel.
 *
 * Queries GitHub Releases for tags prefixed "headless-meta-pixel@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Meta_Pixel_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-meta-pixel@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-meta-pixel';
	const PLUGIN_SLUG = 'headless-meta-pixel';
	const ZIP_NAME    = 'headless-meta-pixel.zip';
	const CACHE_KEY   = 'headless_meta_pixel_gh_release_cache';
