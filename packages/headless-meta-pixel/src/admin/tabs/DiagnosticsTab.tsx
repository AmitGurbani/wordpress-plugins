  ...
  return (
    <DiagnosticsPanel
      ...
      testAction={{
        ...
        description: __(
          'Send a test PageView event to verify your CAPI connection. Make sure you have set a Test Event Code in the General tab first.',
          'headless-meta-pixel',
        ),
      ...
      renderTestExtra={(result) =>
        result.test_event_code ? (
          <p>
            {__('Test Event Code:', 'headless-meta-pixel')}{' '}
            <code>{result.test_event_code as string}</code>
          </p>
        ) : null
      }
    />
