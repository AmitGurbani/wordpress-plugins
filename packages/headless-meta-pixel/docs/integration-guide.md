...
**Base URL:** `https://your-site.com/wp-json/headless-meta-pixel/v1`

If the site uses plain permalinks: `https://your-site.com/?rest_route=/headless-meta-pixel/v1`
...
```http
GET /wp-json/headless-meta-pixel/v1/config
```
...
```ts
const res = await fetch('/wp-json/headless-meta-pixel/v1/config');
...
```http
POST /wp-json/headless-meta-pixel/v1/track
...
await fetch('/wp-json/headless-meta-pixel/v1/track', {
  method: 'POST',
