...
/**
 * Auto-updater for Headless Umami.
 *
 * Queries GitHub Releases for tags prefixed "headless-umami@" and surfaces
 * newer versions through WordPress's native update UI via the WP 5.8+
 * Update URI mechanism.
 */
class Headless_Umami_Updater {

	const GITHUB_REPO = 'AmitGurbani/wordpress-plugins';
	const TAG_PREFIX  = 'headless-umami@';
	const UPDATE_URI  = 'https://github.com/AmitGurbani/wordpress-plugins/releases?plugin=headless-umami';
	const PLUGIN_SLUG = 'headless-umami';
	const ZIP_NAME    = 'headless-umami.zip';
	const CACHE_KEY   = 'headless_umami_gh_release_cache';
